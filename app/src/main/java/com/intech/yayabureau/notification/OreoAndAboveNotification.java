package com.intech.yayabureau.notification;
...
public class OreoAndAboveNotification extends ContextWrapper {
    ...
    private void createChannel() {
        ...
        NotificationChannel notificationChannel =new NotificationChannel(getString(R.string.default_notification_channel_id),NAME, NotificationManager.IMPORTANCE_DEFAULT);
